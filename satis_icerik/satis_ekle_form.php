...
<body>
  <div class="container page ">
    ...
    <div class="container" style="width:81% ;border-radius:20px;;background-image: radial-gradient(100% 100% at 100% 0px,
    white 0px, gray 100%) !important;text-align:center">

      <h1 style="color:brown" class=" mt-4 font-weight-normal">SATIŞ EKLEMEK İÇİN </h1>
      <p style="color:brown ; text-align:center">Lütfen gerekli belgeleri eksiksiz doldurunuz </p>
   <hr>
    <form method="POST" action="satis_ekle_post.php" id='example'>
      

        
          <p style="color:brown" class="mt-2"> ŞİRKET ADI * </p>
        ...
        <div class=" ml-5 mr-5">
          <p style="color:brown"> MÜŞTERİ ADI SOYADI * </p>
        ...
        <div class=" ml-5 mr-5">
          <p style="color:brown"> SATICI PERSONELİN ADI SOYADI *</p>
        ...
        <div class="form-label-group ml-5 mr-5">
          <p style="color:brown" >SATIŞ TARİHİ *</p>
        ...
        <div class="form-label-group mb-4 ml-5 mr-5">
          <p style="color:brown">SATIŞ NOTU *</p>
          <input type="text" class="form-control text-center" name="satis_not" placeholder="satis_not" required="" autofocus="">
        </div>
        <table data-dynamicrows class="table table-bordered table-striped" style="color: brown;">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" name="urun_adi[]" class="form-control" style="color: brown;"></td>
              <td><input type="text" name="urun_adedi[]" class="form-control" style="color: brown;"></td>
              <td><input type="text" name="birim_fiyat[]" class="form-control" style="color: brown;"></td>
