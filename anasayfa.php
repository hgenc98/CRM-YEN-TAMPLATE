...
if ($_SESSION["kullanici"]['role_id'] == 1) {
    ...
    isset($_SESSION['kullanici']['kullanici_id']);
    $sql = $db->prepare('SELECT ziyaretler.*,tamamlayan.kullanici_adi AS tamamlayan_adi,musteriler.musteri_adi,musteri_eleman.eleman_adi,musteriler.baslik AS baslik FROM ziyaretler
    LEFT JOIN musteriler ON ziyaretler.musteri_id = musteriler.id
    LEFT JOIN kullanicilar AS tamamlayan ON ziyaretler.tamamlayan_id = tamamlayan.id
    LEFT JOIN musteri_eleman ON musteri_eleman.id = ziyaretler.musteri_eleman_id
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-primary" style="background: none;border: none;color: black;border-bottom:1px solid ; " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                DENEME SÜRESİNİ GÖRMEK İÇİN TIKLAYINIZ!
                            </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Deneme Süresi</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div style="background: black;color:white">
                                                <?php $sql1 = $db->query('SELECT * FROM firma  where id = ' . $_SESSION['kullanici']["firma_id"] . '')->fetchAll();
                                        ...
                                        <div class="text-center">
                                            <div class="subheader">
                                                <div class="h1 mb-0 me-2 text-center">
                                                    <?php $musteri_sayac_2 = $db->query('SELECT COUNT(*) as sayac FROM ziyaretler where ziyaretler.firma_id = ' . $_SESSION['kullanici']["firma_id"] . '')->fetch();
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            <div class="subheader">
                                                <div class="h1 mb-0 me-2 text-center">
                                                    <?php $musteri_sayac_3 = $db->query('SELECT COUNT(*) as sayac FROM satislar where satislar.firma_id = ' . $_SESSION['kullanici']["firma_id"] . '')->fetch();
